          ...
          <div class="container">
            <div class="row">
              <div class="col-md-6 col-md-push-3">
                <div class="text-center mb-60"><a href="#" class=""><img alt="" src="{{ asset('templates/images/logo-wide.png') }}"></a></div>
                <form name="reg-form" class="register-form form-transparent" method="post">
                  ...
                  <p class="text-gray">Halo, Pelari Hebat!
                    <br>
                    <br>
                    Terima kasih sudah mengunjungi website kami. Kami sangat senang menyambut Anda untuk bergabung dalam komunitas penuh semangat ini.
                    <br>
                    <br>
                    Silakan isi formulir di bawah ini dengan data yang benar dan lengkap. Kami tidak sabar untuk melihat langkah-langkah hebat Anda. Selamat bergabung dan sampai jumpa di garis start!</p>
                    <div class="row">
                      <div class="form-group col-md-12">
                        <label for="form_runner_id">Runner ID / Runner Number</label>
                        <input id="form_runner_id" name="runner_id" class="form-control" type="text" pattern="(?=.*[A-Z])(?=.*[0-9])[A-Z0-9]{6}" maxlength="6" oninput="this.value = this.value.toUpperCase()">
                        <small>Enter a 6-character Runner ID (e.g., RUN001). Use uppercase letters and numbers only.</small>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <small>The name written above will be used for submission verification. Please fill with the name which you use for race registration.
                        </small>
                      </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        ...
                        <input id="form_attachment" name="profile_picture" class="file" type="file" data-show-upload="false" data-show-caption="true">
                    ...
                    <div class="row">
                      <div class="form-group col-md-12">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" id="form_terms" name="terms">
