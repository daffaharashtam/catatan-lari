...
(function ($) {
    ...
    THEMEMASCOT.bmiCalculator = {
        ...
        calculateStandard: function (bmi_form) {
            ...
            var gender = bmi_form
                .find('radio[name="bmi_standard_gender"]')
                .val();

            var total_height_inc =
                parseInt(height_ft, 10) * 12 + parseInt(height_in, 10);
            var bmi =
                (parseFloat(weight_lbs) /
                    (total_height_inc * total_height_inc)) *
                703;
        ...
        calculateMetric: function (bmi_form) {
            var weight_kg = bmi_form
                .find('input[name="bmi_metric_weight_kg"]')
                .val();
            var height_cm = bmi_form
                .find('input[name="bmi_metric_height_cm"]')
                .val();
            var age = bmi_form.find('input[name="bmi_standard_age"]').val();
            var gender = bmi_form
                .find('radio[name="bmi_standard_gender"]')
    ...
    THEMEMASCOT.header = {
        ...
        TM_scrollToFixed: function () {
            ...
            $(".scrolltofixed").scrollToFixed({
                ...
                limit: function () {
                    var limit =
                        $("#footer").offset().top - $(this).outerHeight(true);
                    return limit;
                },
            });
            ...
            function timeline_on_left_and_right() {
                $masonry_timeline
                    ...
                    .each(function (index, element) {
                        ...
                        var last_child_offset = parseInt(
                            last_child.css("top"),
                            10
                        );
                        var prev_last_offset = parseInt(
                            prev_last.css("top"),
                            10
                        );
    ...
    THEMEMASCOT.slider = {
        ...
        TM_flexslider: function () {
            var $each_flex_slider = $(".flexslider-wrapper").find(
                ".flexslider"
            );
                    ...
                    $flex_slider.flexslider({
                        ...
                        start: function (slider) {
                            imagesLoaded($portfolio_gallery, function () {
                                setTimeout(function () {
                                    $portfolio_filter_first_child.trigger(
                                        "click"
                                    );
                                }, 500);
                            });
