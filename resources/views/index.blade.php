            ...
            <div class="col-md-6">
                ...
                <form action="#">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                    <p>
                      Forgot Password? <a href="{{ route('submit') }}">Click Here!</a> </p>
                    </div>
                  </div>
    ...
    <section id="home" class="bg-lighter">
      <div class="container">
        <div class="section-content">
          <div class="row">
            <div class="col-md-6">
            <h3 class="text-uppercase letter-space-1 text-center text-theme-colored bg-lighter mb-20">News/Announcement/Info</h3>
            </div>
            <div class="col-md-6">
              <div class="events-venue border-theme-colored border-2px p-20 pt-0 mt-50 ml-sm-0 pt-sm-80" data-margin-left="-60px">
                <h3 class="text-uppercase letter-space-1 text-center text-theme-colored bg-lighter mb-20" data-margin-top="-40px">Race Calendar</h3>
                <div class="pl-50 pl-sm-0 mb-20">
                  <p>1. Borobudur Race</p>
                </div>
                <div class="pl-50 pl-sm-0 mb-20">
                  <p>2. Marathon Race</p>
                </div>
